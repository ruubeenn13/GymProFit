...
- **Ninguna ruta nueva con id de recurso sin su test de acceso ajeno → 403** (DEC-014). Los tests de controlador con el servicio simulado no valen: hay que levantar el contexto (`AbstractOwnershipTest`).
...
- No cambiar contratos de API a la ligera: hay una app publicada que los consume.
